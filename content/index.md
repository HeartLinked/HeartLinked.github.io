...
我规划投身于 **AI Data Infrastructure** 领域，专注于**大规模 AI 训练的端到端数据链路**——从 **AI 数据湖**、**数据工程系统**到训练侧的**高性能 DataLoader**，为 AI 训练与推理构建高吞吐、强一致、可演化的数据底座，同时也乐于拥抱更广阔的 AI 方向——如 Checkpoint、RL 训练与优化、推理系统等。欢迎联系交流。

我坚持系统工程，持续打磨系统与架构设计的 taste；同时深入实践 AI Agent 工作流，紧跟前沿，探索**生成式软件工程**——AI 时代构建软件的新范式。

## 开源

- <img src="/img/iceberg.svg" className="school-logo" alt="Apache Iceberg logo" /> **Apache Iceberg** Contributor
- <img src="/img/iceberg.svg" className="school-logo" alt="Apache Iceberg logo" /> [Apache Iceberg C++](https://github.com/apache/iceberg-cpp)：累计 60+ commits / 20,000+ LOC，项目 **Top 3 Contributor**
...
<Exp logo="/img/bytedance.svg" company="字节跳动" team="Data 架构 - Ads Infra" time="2026.5 – 2026.8">
  基于 Ray / Ray Data 的广告近线决策系统与广告场景分布式计算框架开发与优化
</Exp>

<Exp logo="/img/shopee.svg" company="Shopee 虾皮" team="机器学习平台 MLP" time="2025.6 – 2025.8">
  基于 Kubernetes 的 AI workload 统一编排与生命周期管理
</Exp>
